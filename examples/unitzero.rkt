...
; Thunk Create a set of conditions where we are able to trade
; And a buy and sell price are satisified
; Assertions -> Model
(define angelic-bitcoin-mod?el
...
(define (make-pyramid-contract model variable)
  (if (sat? model)
